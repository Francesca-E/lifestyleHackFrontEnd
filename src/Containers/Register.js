...
event.preventDefault()
 if(this.state.email.length>1 && this.state.name.length>1 && this.state.password.length>1){
   fetch('https://floating-cove-43869.herokuapp.com/register',{
    method:'post',
    ...
    <main className="pa4 black-80">
      <div className="measure center">
        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
          <p className='i white'> Please create a user profile and sign in with your details </p>
        ...
        <div className="mt3">
          ...
          className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"  type="email" name="email"  id="email"/>
        </div>
        <div className="mv3">
